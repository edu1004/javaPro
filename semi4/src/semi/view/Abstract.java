...
public class Abstract extends JFrame {
	...
	private JButton abstractclass = new JButton("abstract class ±¸Çö");
	...
	public Abstract() {
		...
		contentPane.add(abstract1);
		contentPane.add(abstractclass);
		...
		abstract1.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Dialog_.dialog(abstract1.getText());
			}
		});

		abstractclass.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Dialog_.dialog(abstractclass.getText());
			}
		});
